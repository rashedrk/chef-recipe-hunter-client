...
const ChefCard = ({chef}) => {
    const {chef_pic,name,years,recipes,likes} = chef
    return (
        <div className="card w-96 bg-base-100 shadow-xl">
            <figure className="px-10 pt-10">
                <img src={chef_pic} alt="Shoes" className="rounded-xl" />
            </figure>
            <div className="card-body  text-left">
                ...
                <div className="card-actions">
                    <button className="btn border-none bg-red-600 hover:bg-red-500">View recipes</button>
                </div>
            </div>
        </div>
    );
